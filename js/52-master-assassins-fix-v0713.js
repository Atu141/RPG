/* V0.70.13 — Correção funcional de monstros + painel completo dos 4 assassinos. */
(function(){
  ...
  async function addMonster(id){
    if(typeof data==='undefined'||!data)throw new Error('Dados da campanha ainda não foram carregados.');
    await ensureCatalog();
  ...
  function renderAssassins(){
    ...
    if(!host||typeof data==='undefined'||!data)return;
